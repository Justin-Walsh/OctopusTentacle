...
namespace Octopus.Tentacle.Tests.Commands
{
    ...
    public class RunAgentCommandFixture : CommandFixture<RunAgentCommand>
    {
        ...
        IKubernetesPodMonitorTask kubernetesJobMonitorTask = null!;
        ...
        public override void SetUp()
        {
            ...
            kubernetesJobMonitorTask = Substitute.For<IKubernetesPodMonitorTask>();
            ...
            Command = new RunAgentCommand(
                ...
                new Lazy<IKubernetesPodMonitorTask>(() => kubernetesJobMonitorTask));
